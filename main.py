...
def plot_confusion_matrix(predictions, classifier_name):
    cm = confusion_matrix(y_test, predictions)
    print(cm)

plot_confusion_matrix(svm_grid_predictions, 'SVM')
plot_confusion_matrix(rf_grid_predictions, 'Random Forest')
plot_confusion_matrix(et_grid_predictions, 'Extra Trees')

#mapa de calor
def plot_confusion_matrix_map(predictions, classifier_name):
    conf_mx = confusion_matrix(y_test, predictions)
    plt.matshow(conf_mx, cmap=plt.cm.gray)

plot_confusion_matrix_map(svm_grid_predictions, 'SVM')
plot_confusion_matrix_map(rf_grid_predictions, 'Random Forest')
plot_confusion_matrix_map(et_grid_predictions, 'Extra Trees')
